...
urlpatterns = (
    ...
    url(r'^firefox/desktop', views.FirefoxProductDesktop, name='firefox.desktop.index'),
    ...
    url(r'^firefox/android', views.FirefoxProductAndroid, name='firefox.android.index'),
    page('firefox/android/faq', 'firefox/android/faq.html'),
    url(r'^firefox/ios', views.FirefoxProductIOS, name='firefox.ios'),
